...
> {
    ...
    if (!IdentityStore.hasProFeatures()) {
      try {
        await FeatureUsageStore.displayUpgradeModal('translation', {
          headerText: localized('Translate automatically with Courier Pro'),
  ...
  _onNeverForLanguage = () => {
    ...
    const response = require('@electron/remote').dialog.showMessageBoxSync({
      ...
      detail: localized(
        'Courier will no longer offer to translate messages written in %@.',
        ...
        <div className="translate-message-header">
          <div className="message with-actions">
            <div className="message-centered">
              {localized(
                'Courier has translated this message into %@.',
