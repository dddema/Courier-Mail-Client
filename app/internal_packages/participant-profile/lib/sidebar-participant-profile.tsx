    ...
    try {
      await FeatureUsageStore.markUsedOrUpgrade('contact-profiles', {
        ...
        rechargeText: `${localized(
          `You can view contact profiles for %1$@ emails each %2$@ with Courier Basic.`
  ...
  _renderFindCTA() {
    ...
    return (
      <div style={{ textAlign: 'center', marginBottom: 20 }}>
        <p>
          {localized(
            `The contact sidebar in Courier Pro shows information about the people and companies you're emailing with.`
          )}
        </p>
