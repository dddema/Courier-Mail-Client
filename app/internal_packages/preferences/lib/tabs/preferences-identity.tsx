...
> {
        ...
        <div className="row padded">
          <div style={{ display: 'flex', alignItems: 'flex-start' }}>
            <div className="basic-explanation" style={{ display: 'flex' }}>
              {localizedReactFragment(
                `You are not signed in to Courier. Link the app to a free Courier ID to use great free features like send later and snoozing, or upgrade to Courier Pro for unlimited message translation and more.`
              )}
              <div
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start' }}>
          <div className="basic-explanation">
            {localizedReactFragment(
              ...
              <strong>{localized('Courier Basic')}</strong>
            )}
            {process.platform === 'linux' && (
              <span>
                {localizedReactFragment(
                  `Courier is independent %@ software, and subscription revenue allows us spend time maintaining and improving the product.`,
            ...
            {localizedReactFragment(
              ...
              <a onClick={onLearnMore}>{localized('Courier Pro')}</a>
            )}
  ...
  _renderPaidPlan(planName, effectivePlanName) {
    ...
    const unpaidNote = effectivePlanName !== planName && (
      <p>
        {localized(
          `Note: Due to issues with your most recent payment, you've been temporarily downgraded to Courier %@. Click 'Billing' below to correct the issue.`,
          effectivePlanName
        )}
      </p>
    );
      ...
      <div className="row padded">
        <div>
          {localizedReactFragment(
            ...
            <strong style={{ textTransform: 'capitalize' }}>{`Courier ${planDisplayName}`}</strong>,
...
const ExploreMailspringPro: React.FunctionComponent = () => (
  <>
    <div className="feature-explore-title">{localized('Explore Courier Pro')}</div>
