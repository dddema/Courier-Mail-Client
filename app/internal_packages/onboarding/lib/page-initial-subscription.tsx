  ...
  render() {
    return (
      <div className="page opaque initial-subscription" style={{ width: 900, height: 620 }}>
        <h1 style={{ paddingTop: 100 }}>{localized(`Go further with Courier Pro`)}</h1>
        <div
          style={{
            display: 'flex',
          ...
          <div className="basic-explanation">
            <p>
              {localizedReactFragment(
                ...
                <strong>Courier Basic</strong>
              )}
            </p>
            <p>
              {localizedReactFragment(
                `If you enjoy Courier, upgrade to Courier Pro from %@ to enable all these great features permanently:`,
